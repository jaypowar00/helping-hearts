...
urlpatterns = [
    ...
    url(r'^hospital/get-coworkers/$', views.get_coworkers, name='get_coworkers_for_hospitals'),
    url(r'^hospital/get-working-coworkers/$', views.get_working_coworkers, name='get_working_coworkers_for_hospitals'),
